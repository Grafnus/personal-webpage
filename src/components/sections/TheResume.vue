...
<template>
	<section id="resume" class="grid bg-stone-200 min-h-screen w-screen text-white z-0">
		<div class="w-3/5 mx-auto">
			<div class="container mt-24">
				<div class="mb-16">
					<h4 class="uppercase font-bold text-cyan-400 text-center text-xl poppins tracking-widest">Timeline</h4>
					<h1 class="uppercase font-bold text-black text-center text-2xl poppins tracking-tight">What happend so far</h1>
				</div>
				

				<ol class="relative border-l border-stone-400 dark:border-gray-700 z-0">                  
					<li class="mb-16 ml-6">            
